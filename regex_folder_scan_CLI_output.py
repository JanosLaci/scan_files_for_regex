...
parser.add_argument("-s", "--start", required=False, help="Start the scan at this line.")
parser.add_argument("-e", "--end", required=False, help="End the scan at this line.")
...
def main():
    ...
    if args.output:
        ...
        with open(output_path, "a") as writer:
            line_to_append = r"file_containing_regex,line_beginning,line_ending,type_found,datetime_of_scan"
                    ...
                    for match in matches:
                        ...
                        if args.output:
                            with open(output_path, "a") as writer:
                                ...
                                line_to_append = f"{path},{line_beginning},{line_ending},{pattern_select_star},{current_date_and_time}"
